...
(function (global) {
  ...
  var ITEM_BANK = {
    Spark: [
      ...
      "「話してみたいな」と思う人がいたら、自分から話しかけてみる",
      "みんなが黙っているとき、最初に口を開くのは自分のことが多い",
    ],
    Bridge: [
      "別々の友達同士を紹介して、友達の輪が広がったことがある",
      "グループに新しい人が入ってきたら、なじめるように声をかける",
      "「この2人、友達になったら合いそう」と思ったら、実際に会わせてみる",
      "タイプの違ういくつかのグループに、それぞれ顔を出している",
    ],
    Shepherd: [
  ...
  var RESOURCES = [
    {
      title: "アルファ・ユース",
      sub: "Alpha Youth Series",
      description:
        "人生・信仰・イエスについて、友達と気軽に話し始めるための映像シリーズ（全13エピソード）。初めての人にも入りやすい構成。",
      target: "中高生、大学生、初めて信仰に触れる友達、ユースグループ",
      caution: "教会によって受け止め方が異なるテーマが含まれる場合があります。使用前に、必要に応じて牧師先生やユースリーダーに相談してください。",
      link: "https://japan.alpha.org/alphayouthseries/",
      linkLabel: "公式サイトを見る →",
      icon: "https://www.google.com/s2/favicons?domain=japan.alpha.org&sz=128",
      initial: "A",
    },
    {
      title: "hi-b.a.（ハイビーエー）",
      sub: "高校生聖書伝道協会",
      description:
        "中高生・若者向けの聖書の学びや交わりに役立つリソース。毎週日本全国で高校生たちのイベントが開かれています。よくわからなくても、放課後に友達を連れて行ける気軽さが魅力。中高生伝道に特化したhi-b.a.のスタッフが必ずフォローしてくれます。",
      target: "中高生",
      caution: "使用前に、必要に応じて牧師先生やユースリーダーに相談してください。",
      link: "https://www.hi-ba.com/club/",
      linkLabel: "クラブを探す →",
      icon: "https://www.hi-ba.com/hi-ba/wp/wp-content/themes/hiba/common/image/logo_hiba.svg",
      initial: "h",
    },
    {
      title: "聖書プロジェクト",
      sub: "BibleProject Japanese",
      description:
        "聖書の各書巻やテーマを、美しいアニメーション動画で解説する無料のYouTubeチャンネル。友達と一緒に観るのにもぴったり。",
      target: "中高生、大学生、ノンクリの友達と一緒に",
      caution: "使用前に、必要に応じて牧師先生やユースリーダーに相談してください。",
      link: "https://www.youtube.com/@BibleProjectJapanese",
      linkLabel: "YouTubeで見る →",
      icon: "https://yt3.googleusercontent.com/ytc/AIdro_mRtNjKeO9mOa0zzwUVkFiS8Zy07BPyQEXHXwGlfvwADQ=s176-c-k-c0x00ffffff-no-rj",
      initial: "聖",
    },
    {
      title: "ともに聴く聖書",
      sub: "PRS Bible（iOSアプリ）",
      description:
        "プロの朗読と効果音で、ドラマのように聖書を「聴ける」アプリ。通学中や寝る前に。仲間と一緒に聴き進めるグループ機能も。",
      target: "中高生、大学生、ユースグループ",
      caution: "使用前に、必要に応じて牧師先生やユースリーダーに相談してください。",
      link: "https://apps.apple.com/jp/app/%E3%81%A8%E3%82%82%E3%81%AB%E8%81%B4%E3%81%8F%E8%81%96%E6%9B%B8-prs-bible/id6474954895",
      linkLabel: "App Storeで見る →",
      icon: "https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/1f/ec/a2/1feca2aa-7b09-ea3f-4ca1-81d1c269b673/AppIcon-0-0-1x_U007emarketing-0-8-0-0-85-220.png/512x512bb.jpg",
      initial: "聴",
    },
    {
      title: "KGK「WITH」",
      sub: "キリスト者学生会 — 学内活動シリーズ",
      description:
        "クリスチャンではない友人と一緒に使うことを想定した伝道用ブックレット「WITH」。学内・キャンパスでの少人数の学びに。",
      target: "大学生、学生バイブルスタディ",
      caution: "使用前に、必要に応じて牧師先生やユースリーダーに相談してください。",
      link: "https://www.kgkjapan.org/%E5%AD%A6%E5%86%85%E6%B4%BB%E5%8B%95%E3%82%B7%E3%83%AA%E3%83%BC%E3%82%BA",
      linkLabel: "公式サイトを見る →",
      icon: "https://www.google.com/s2/favicons?domain=kgkjapan.org&sz=128",
      initial: "K",
    },
    {
      title: "Cru（日本キャンパスクルセード）",
      sub: "Japan CCC 教材",
      description:
        "「四つの法則」をはじめ、伝道・弟子訓練の定番教材がそろうページ。信仰の基礎を友達と学ぶときの参考に。",
      target: "大学生、若者、信仰の基礎を学びたい人",
      caution: "使用前に、必要に応じて牧師先生やユースリーダーに相談してください。",
      link: "https://www.japanccc.org/material/",
      linkLabel: "教材ページを見る →",
      icon: "https://www.japanccc.org/wp-content/uploads/2022/05/JCCCLogo.png",
      initial: "C",
    },
    {
      title: "あなたの教会のリソース",
      sub: "Your Church Resources",
